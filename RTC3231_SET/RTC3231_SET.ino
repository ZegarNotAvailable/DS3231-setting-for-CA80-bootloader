// ------------------------------------------------------------------------------
//  Part of Z80-MBC2 software. (Author J4F)
//  Hardware definitions RTC Module Option (see DS3231 datasheet)
//  Should work on any Arduino.
// ------------------------------------------------------------------------------
...
void setup() 
{
  ...
  if (foundRTC)
    {
      Serial.println("Change RTC time/date");
